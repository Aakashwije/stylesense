...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/dashboard/queue": "Live Queue",
  "/dashboard/waitlist": "Waitlist Manager",
  "/dashboard/stylists": "Stylists",
  "/dashboard/services": "Services",
  "/dashboard/customers": "Customers",
  "/dashboard/inventory": "Inventory",
  "/dashboard/utilisation": "Staff Utilisation",
  "/dashboard/earnings": "Earnings",
  "/dashboard/pos": "POS / Checkout",
  "/dashboard/analytics": "AI Analytics",
  "/dashboard/marketing": "Marketing Hub",
  "/dashboard/rfm": "Client Segments",
